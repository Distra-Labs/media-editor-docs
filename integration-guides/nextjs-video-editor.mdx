...
Follow [Installation](/installation) for the version 2 setup. This page is being
rewritten.
</Warning>
...
const VideoEditor = dynamic(
  () => import('@layermetry/media-editor').then(mod => ({ default: mod.VideoEditor })),
  { ssr: false }
);
...
1. See [FAQ](/troubleshooting/faq) for common issues and solutions
2. See [Next.js ImageEditor Integration](/integration-guides/nextjs-image-editor) for image editing
3. Check the included example project for a complete working implementation

## Support

For issues or questions:
- Support Portal: Contact your account manager or support@layermetry.com
