...
1. See [FAQ](/troubleshooting/faq) for common issues and troubleshooting
2. See [Next.js VideoEditor Integration](/integration-guides/nextjs-video-editor) for video editing
